...
(async function () {
    ...
    mySQLDriver.createDateDimensionTable("dDate", new Date("1996-01-01"), new Date("1998-12-31")).then(() => {
    ...
    }).then(() => mySQLDriver.createTimeDimensionTable('dTime'))
        .then(() => {
        ...
        return new ETLTask_1.default(1, '<Create dProduct dimension table>')
        ...
        return new ETLTask_1.default(2, '<Create dEmployee dimension table>')
        ...
        return new ETLTask_1.default(3, '<Create dSupplier dimension table>')
        ...
        return new ETLTask_1.default(4, '<Create dCustomer dimension table>')
        ...
        return new ETLTask_1.default(5, '<Create fact table>').fromSQLDatabase(postgreSQLDriver, `SELECT p."ProductID", e."EmployeeID", s."SupplierID", c."CustomerID", o."OrderDate" , SUM(od."UnitPrice" * od."Quantity" * (1 - od."Discount")) AS "TotalPrice" 
